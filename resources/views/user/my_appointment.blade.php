  ...
  <div align="center" style="padding:70px;">
    <table>
        <tr style="background-color:black;">
            <th style="padding:10px;font-size:20pz;color:white;" >Doctor Name</th>
            <th style="padding:10px;font-size:20pz;color:white;">Date</th>
            <th style="padding:10px;font-size:20pz;color:white;">Message</th>
            <th style="padding:10px;font-size:20pz;color:white;">Status</th>
            <th style="padding:10px;font-size:20pz;color:white;">Cancel Appointment</th>
        </tr>
